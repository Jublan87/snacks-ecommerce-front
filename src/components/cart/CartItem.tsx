...
export default function CartItem({
  ...
  const titleStyles =
    variant === 'card'
      ? 'font-semibold text-lg text-gray-900 hover:text-[#FF5454] transition-colors mb-2'
      : 'font-semibold text-gray-900 truncate hover:text-[#FF5454] transition-colors';
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center gap-3">
            ...
            <span
              className={`w-10 text-center font-medium ${quantityTextSize}`}
            >
              {item.quantity}
            </span>
            <Button
